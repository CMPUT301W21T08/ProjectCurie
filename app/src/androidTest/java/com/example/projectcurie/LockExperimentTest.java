...
public class LockExperimentTest {
    ...
    @Test
    public void lockExperimentTest() throws InterruptedException {
        Thread.sleep(3000);
        ...
        ViewInteraction appCompatButton5 = onView(
                allOf(withId(android.R.id.button2), withText("Lock"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction appCompatButton6 = onView(
                allOf(withId(android.R.id.button2), withText("Unlock"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.ScrollView")),
                                        0),
